...
public class StorageESP extends Module {
    ...
    public static void drawESP(final Entity e, int color, final boolean damage, final int type) {
        ...
        final double x = e.lastTickPosX + (e.posX - e.lastTickPosX) * timers().renderPartialTicks - StorageESP.mc.getRenderManager().viewerPosX;
        final double y = e.lastTickPosY + (e.posY - e.lastTickPosY) * timers().renderPartialTicks - StorageESP.mc.getRenderManager().viewerPosY;
        final double z = e.lastTickPosZ + (e.posZ - e.lastTickPosZ) * timers().renderPartialTicks - StorageESP.mc.getRenderManager().viewerPosZ;
    ...
    public static void dtl(final Entity e, final int color, final float lw) {
        ...
        final double x = e.lastTickPosX + (e.posX - e.lastTickPosX) * timers().renderPartialTicks - StorageESP.mc.getRenderManager().viewerPosX;
        final double y = e.getEyeHeight() + e.lastTickPosY + (e.posY - e.lastTickPosY) * timers().renderPartialTicks - StorageESP.mc.getRenderManager().viewerPosY;
        final double z = e.lastTickPosZ + (e.posZ - e.lastTickPosZ) * timers().renderPartialTicks - StorageESP.mc.getRenderManager().viewerPosZ;
        final float a = (color >> 24 & 0xFF) / 255.0f;
        final float r = (color >> 16 & 0xFF) / 255.0f;
        final float g = (color >> 8 & 0xFF) / 255.0f;
