...
public class Nameplate {
    ...
    public void renderNewPlate(Color col) {
        ...
        int width = rm.getFontRenderer().getStringWidth(owner.getName()) / 2;
        ...
        rm.getFontRenderer().drawString(owner.getName(), -rm.getFontRenderer().getStringWidth(owner.getName()) / 2, 0, 0x20FFFFFF);
        GlStateManager.enableDepth();
        GlStateManager.depthMask(true);
        rm.getFontRenderer().drawString(owner.getName(), -rm.getFontRenderer().getStringWidth(owner.getName()) / 2, 0, -1);
