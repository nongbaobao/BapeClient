package mc.bape.Gui.LiquidBaseClickGui.UI;
...
public class ClickGUI extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        // DO NOT DELETE THIS!
        fontRendererObj.drawStringWithShadow(Client.name + Client.version, 5, this.height - 20, new Color(255, 255, 255).hashCode());
        fontRendererObj.drawStringWithShadow("Bape is a free client, if you pay any money for it mean you got deceived.", 5, this.height - 10, new Color(255, 0, 0).hashCode());
