...
public class Lune extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        FontLoaders.F18.drawStringWithShadow(Client.name + Client.version+" By James_Tylor, credits: Medit_4 SuperSkidder LoRyu cubk", 5, 2, new Color(255, 255, 255).hashCode());
